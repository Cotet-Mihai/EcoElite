...
export default function MissionSection() {
    return (
        <section className="py-12 px-6 lg:px-10">
            <div className="max-w-7xl mx-auto bg-primary/50 rounded-[3rem] overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-16 p-8 lg:p-12 relative z-10">
                    ...
                    <div className="relative group">
                        <div className="absolute -inset-4 border border-foreground/20 rounded-[2.5rem] rotate-12 scale-95 group-hover:rotate-0 transition-transform duration-700" />
                    ...
                    <div className="text-white space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2">
                            <Button
                                variant='outline'
                                className="h-12 px-8 rounded-full text-primary hover:bg-foreground hover:text-secondary border-none font-bold group text-sm hover:scale-102 transition-transform"
                            >
                                Află Mai Mult
                        ...
                        <div className="pt-30 flex flex-wrap gap-4 opacity-60">
                            <div className="text-[9px] font-black uppercase tracking-widest border-foreground/20 border-2 px-2 py-1 rounded text-foreground">ISO 14001</div>
                            <div className="text-[9px] font-black uppercase tracking-widest border-foreground/20 border-2 px-2 py-1 rounded text-foreground">Green Certified</div>
                        </div>
                    </div>
